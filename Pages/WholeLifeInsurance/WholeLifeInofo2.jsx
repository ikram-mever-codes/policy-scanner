...
const WholeLifeInofo2 = () => {
  return (
    <section className="w-full h-max  bg-white gap-[3rem] px-[80px] py-[60px]  pt-0 pb-0 flex justify-center items-center flex-col">
      <div className="w-[1140px] h-full flex justify-center items-center flex-col gap-[2rem]">
        ...
        <div className="w-full h-max flex justify-between items-start gap-[4rem] ">
          <div className="w-full h-max flex justify-between items-center flex-col gap-[2rem] px-0 p-[1rem]">
