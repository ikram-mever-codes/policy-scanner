    ...
    <section className="w-full h-max  bg-foreground2 gap-[3rem] px-[80px] py-[5rem] flex justify-center items-center flex-col">
      <div className="w-[75%] h-full flex justify-center items-center flex-col gap-[2rem]">
        ...
        <div className="w-full h-max flex justify-start items-start p-[1rem] rounded-xl border border-solid border-opposite gap-[10px] flex-col">
          <h3 className="font-semibold text-left">Regular premium payments </h3>
        ...
        <div className="w-full h-max flex justify-start items-start p-[1rem] rounded-xl border border-solid border-opposite gap-[10px] flex-col">
          <h3 className="font-semibold text-left">Limited pay options </h3>
          <p className="text-[15px] text-left">
        ...
        <div className="w-full h-max flex justify-start items-start p-[1rem] rounded-xl border border-solid border-opposite gap-[10px] flex-col">
          <h3 className="font-semibold text-left">Single premium payment </h3>
          <p className="text-[15px] text-left">
