...
//               Compare and Buy Canada's <br /> Best Mortgage Insurance
//             </h1>
//             <p className="w-full text-halfBlack text-[22px] font-semibold text-left ">
...
//           <Link
//             href="#"
//             className="relative group flex justify-center items-center text-[18px] self-start w-[20rem] h-[5rem] shadow-2xl text-halfBlack rounded-2xl bg-white border border-solid hover:text-white border-primary transform transition-all duration-300 hover:scale-105 hover:shadow-lg cursor-pointer overflow-hidden"
//           >
...
//             <span className="relative z-10">Compare Mortgage Protection</span>
//           </Link>
//         </div>
//       </div>
      ...
      >
        <div className="max-w-2xl">
          <h1 className="text-[50px] font-bold leading-[4rem] text-left text-white">
            Secure your home &<br /> family's future
          </h1>
          <p className="text-[18px] my-[2.5rem] text-white/90">
            Compare mortgage protection quotes from leading insurance providers
          </p>
