...
const MortgageInfo5 = () => {
  return (
    <section className="w-full h-max  bg-white gap-[3rem] px-[80px] mb-[60px] flex justify-center items-center flex-col">
      <div className="w-[1140px] h-full flex justify-center text-halfBlack items-center flex-col gap-[1rem]">
        ...
        <h3 className="text-[22px] font-semibold w-full text-left">
        ...
        <div className="w-full h-max flex justify-start items-start gap-[2rem] flex-col ">
          ...
          <div className="w-full h-max flex justify-start items-start flex-col gap-[2rem]">
            <div className="w-full flex justify-start items-start gap-[4rem]">
              ...
              <div className="text-dg text-halfBlack">
