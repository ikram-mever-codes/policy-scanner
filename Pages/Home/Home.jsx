...
const Home = () => {
  return (
    <div className="overflow-hidden">
      ...
      <Stats />
      <Reviews />
      <div className="w-full h-max flex  justify-center items-center my-[20px] ">
        <div className="flex  h-[570px]  w-[1140px]  overflow-hidden  justify-center   flex-col items-center gap-[20px]  ">
