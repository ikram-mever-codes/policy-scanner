  ...
  return (
    <section className="w-full h-max  bg-white gap-[3rem] px-[80px] py-[60px] flex justify-center items-center flex-col">
      <div className="w-[1140px] h-full flex justify-center items-center flex-col gap-[2rem]">
        ...
        <p className="w-full text-halfBlack text-left text-dg">
        ...
        <div className="w-full h-max flex justify-start items-start  p-8 rounded-xl border border-solid border-opposite gap-[10px] flex-col line-h ">
          ...
          <p className="text-[15px] text-left text-halfBlack text-dg">
        ...
        <div className="w-full h-[350px] flex justify-between items-center  gap-[2rem] mt-[2rem] ">
          <div className="w-full h-full flex justify-center items-center flex-col gap-[2rem]">
            <div className="w-full h-max flex justify-start items-start p-4 rounded-xl border border-solid border-opposite gap-[10px] flex-col">
            ...
            <div className="w-full h-max flex justify-start items-start p-4 rounded-xl border border-solid line-h border-opposite gap-[10px] flex-col">
              <h3 className="font-semibold text-left">
                Choose a beneficiary:{" "}
              </h3>
              <p className="text-[15px] text-left text-dg text-halfBlack">
