...
const ConnectCta = ({ bg }) => {
  return (
    <section
      ...
      className="w-full  h-max  py-[30px] md:py-[50px] flex flex-col lg:flex-row justify-center items-center my-[80px] gap-[116px]"
    >
      <Image
        src={ctaImg}
        alt="Contact Us"
      ...
      <div className="w-max px-[10px] md:px-[20px] h-max flex justify-center items-start gap-[10px] md:gap-[20px] flex-col">
        ...
        <h4 className="text-left text-dg">
          Get a free no-obligation quote. At PolicyScanner, we respect
          <br />
          your privacy and don't make multiple follow-up calls.
        </h4>
